...
<html>
	...
	.head
		...
		<table style="margin-left:450px;margin-top:250px;width:450px;border: 1px solid white;background-color:#52527a;opacity:0.7">
			<tr>
				<th class="head" colspan="2" style="text-align:center;border-bottom: 1px solid #ddd;"><marquee scrollamount="2" direction="right" behavior="alternate">| DELETE ITEM FROM NON-VEG MENU |</marquee></th>
			</tr>
			<tr>
				<th class="head">ITEM ID [ 101-200 ]</th>
