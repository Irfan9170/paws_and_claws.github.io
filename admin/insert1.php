...
<html>
	...
	.head
		...
		<form action="insertdog.php" method="post">
		<table style="margin-left:450px;margin-top:200px;width:450px;border: 1px solid white;background-color:#52527a;opacity:0.7">
			<tr>
				<th class="head" colspan="2" style="text-align:center;border-bottom: 1px solid #ddd;"><marquee scrollamount="2" direction="right" behavior="alternate">| INSERT ITEM IN DOG MENU |</marquee></th>
			</tr>
			<tr>
					<th class="head ">IMAGE URL :</th>
					<td><input class="inpt" type="text" name="image" placeholder="ENTER IMAGE URL" value="dog/" required /></td>
