			...
			if($_GET["action"]=="delete")
			{
				foreach($_SESSION["shopping_cart"] as $keys => $values)
				{
					if($values["item_id"]==$_GET["id"]) 
					{
						...
						echo '<script>window.location="index1.php#cart"</script>';
					}
				}
			}
		}
					...
					<div class="col-md-3" style="height:400px;">
						...
						<form method="post" action="index1.php?action=add&id=<?php echo $row["id"];?>">
							<div id="box" style="border:1px solid #333; background-color: #000f1a; border-radius:5px; padding:10px;" align="center">
								...
								<input type="text" name="quantity" class="form-control" min="1" max="3" value="1"/>
						...
						<table class="table table-bordered">
							...
							<?php
								...
								<tr>
									...
									<td><a style="text-decoration:none;" href="index1.php?action=delete&id=<?php echo $values["item_id"]?>"><span class="btn btn-danger">Remove</span></a></td>
								</tr>
							...
							?>
								...
								<tr>
									<td colspan="5" align="center"><a style="text-decoration:none;letter-spacing:10px;" href="checkout.php"><span class="btn btn-primary">| CHECKOUT |</span></a></td>
								</tr>
							<?php
								}
							?>
