<?php
	...
	if(isset($_POST['request']))
		{	$date=$_POST['date'];
			...
			$sq="INSERT INTO petspa (date,name,email,mobile,pettype,locality) 
			...
			echo '<script>window.location="petspa.php"</script>';
			}
...
<body>
		...
		<img style="margin-left:220px;margin-top:60px;height:200px;opacity:1;"src="spa.png"></img>
		<img style="margin-top:60px;height:200px;opacity:1;"src="ss.jpg"></img>
		<img style="margin-top:60px;height:200px;opacity:1;"src="spa2.jpg"></img>
		<img style="margin-top:60px;height:200px;opacity:1;"src="spa3.jpg"></img>
		...
		<form action="" method="post">
			<table style="border: 1px solid white;background-color:#132639;width:400px;margin-top:20px;margin-left:500px;opacity:0.7;">
				<tr style="color:white;">
					<th class="head" colspan="2" style="text-align:center;border-bottom: 1px solid #ddd;"><marquee scrollamount="2" behavior="alternate">| BOOK APPOINTMENT FOR PET SPA |</marquee></th>
				</tr>
				<tr>
					<th class="head ">DATE :</th>
					<td><input class="inpt" type="date" name="date" maxlength="30"  placeholder="yyyy-mm-dd" required /></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input class="inpt" type="radio" name="pettype" value="dog" required />DOG</td>
					<td></td>
				</tr>
				<tr>
